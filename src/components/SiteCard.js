...
const SiteCard = ({ site, showUpdateButton = false, showDeleteButton = false }) => {
    ...
    return (
        <div className="card">
            <div className="position-absolute"
                style={{ right: "0" }}>
                <button onClick={()=>handleDelete(site._id)} className="btn btn-light text-dark" style={{ opacity: "0.5" }} value="65454x">x</button>
            ...
            <div className="card-body text-left">
                ...
                {showUpdateButton && (
                    <Fragment>
                        <div className="my-5">
                            <Link to={`/site/update/${site._id}`} className="text-success" title="Modifier ce site">
