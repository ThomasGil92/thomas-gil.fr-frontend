                    ...
                    <div className="col-md-6 col-12">
                        ...
                        >
                            ...
                            <p style={{ fontWeight: "200" }} className="justify">
                                ...
                                utilisée par bon nombre d'autre grandes applications (Airbnb,
                                Uber, Instagram, ...)
                <br />
                Grace à React, je peux créer des interfaces utilisateurs ultra
                        ...
                        >
                            <div>
                                ...
                                <p style={{ fontWeight: "200" }} className="justify">
                                    ...
                                    Conception de votre site ou application web coté serveur.<br /> Je peux façilement intégrer des données à votre site web en temps réel. Pour cela j'utilise Node.js.
                <br />
                                </p>
                                <p style={{ fontWeight: "200" }} className="justify">
                                    Node.js me permet de créer une API pour transférer des datas entre votre base de données et votre application web tout en garantissant leurs sécurité.
</p>
                            </div>
                    ...
                    <div className="col-md-6 d-flex align-items-center">
                        ...
                        >
                            ...
                            <p className="lead mb-0 mt-3">AWS (S3 / SES / IAM / Amplify) / Heroku / Firebase</p>
                            <div className="progress">
                                <div
                                    className="progress-bar progress-bar-striped text-dark text-right font-weight-bold pr-2 progress-bar-animated"
                                    role="progressbar"
